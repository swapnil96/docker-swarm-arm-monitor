FROM swapnil18/docker-arm-prometheus

ARG "version=0.1.0-dev"
ARG "build_date=6/7/17"
...
LABEL org.label-schema.vendor="Personal" \
    ...
    org.label-schema.url="https://github.com/swapnil96/docker-swarm-arm-monitor/blob/master/README.md" \
